...
public class ColoringEditor extends TextEditor {
    ...
    public ColoringEditor() {
        ...
        ColorManager colorManager = Activator.getDefault().getColorManager();
    ...
    private int getTabSize() {
        return Activator.getDefault().getPreferenceStore().getInt(ColoringSourceViewerConfiguration.PREFERENCE_TAB_WIDTH);
    }
    ...
    protected void updateStatusField(String category) {
        ...
        if (category.equals(Activator.STATUS_CATEGORY_MODE)) {
            IStatusField field = getStatusField(category);
            if (field != null) {
                field.setImage(Activator.getImage("box"));
    ...
    protected boolean affectsTextPresentation(PropertyChangeEvent event) {
        return Activator.getDefault().getEditorTools().affectsTextPresentation(event);
    }
