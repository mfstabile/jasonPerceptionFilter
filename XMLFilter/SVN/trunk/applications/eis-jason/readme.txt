...
the Elevator example. In this case we just provide the environment.
The code of the agents are to be coded.
...
. Jason >= 1.4.1 (jason.jar of this release is included in this package)
