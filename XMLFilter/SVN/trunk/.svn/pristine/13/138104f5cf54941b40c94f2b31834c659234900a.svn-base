...
import net.sourceforge.jasonide.editors.cbg.Modes;
...
public class Mode {
    ...
    public void load() {
        ...
        // Germano - try to read file from Jason home.
        String filePath = JasonPluginConstants.JASON_HOME_JEDIT + File.separator + filename;
