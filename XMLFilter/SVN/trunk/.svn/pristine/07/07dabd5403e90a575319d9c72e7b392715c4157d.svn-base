...
public class AddEditAslSourcePathShell {
    ...
    public AddEditAslSourcePathShell(MAS2JTextEditor editor, List lbAslSourcePath, int action) {
        this.lbAslSourcePath = lbAslSourcePath;
        this.action = action;
        createSShell();
    ...
    private void createSShell() {
        ...
        sShell.setText("ASL Source Path");
            ...
            public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
                ...
                if (iei instanceof IFileEditorInput) {
                    ...
                    if (action == ACTION_INSERT) {                                  
                        ...
                        int index = lbAslSourcePath.getSelectionIndex();
                        String oldPath = lbAslSourcePath.getItem(index);
                        
                        lbAslSourcePath.remove(index);
                        lbAslSourcePath.add(path, index);
                        ...
                        try {
                            ...
                            try {
                                ...
                                int i = project2.getSourcePaths().indexOf(oldPath);
